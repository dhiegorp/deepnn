...
MAP_DIMS = {
	'AE_UNIGRAMA_4L_UNDER_01' :  [96,  28,  26, 24, 22, 9],
	'AE_UNIGRAMA_4L_UNDER_02' :  [96,  76,  69, 63, 56, 9],
	'AE_UNIGRAMA_4L_UNDER_03':   [96,  86,  78, 71, 63, 9],
	'AE_UNIGRAMA_4L_OVER_04':    [96, 134, 122, 109, 97, 9],
	'AE_UNIGRAMA_4L_OVER_05' :   [96, 172, 156, 139, 123, 9]
}
