...
MAP_DIMS = {
	'AE_UNIGRAMA_7L_UNDER_01' :  [96,  28,  26, 24, 22, 20, 19, 17, 9],
	'AE_UNIGRAMA_7L_UNDER_02' :  [96,  76,  69, 63, 56, 49, 43, 36, 9],
	'AE_UNIGRAMA_7L_UNDER_03':   [96, 86, 78, 71, 63, 55, 48, 40, 9],
	'AE_UNIGRAMA_7L_OVER_04':    [96, 134, 122, 109, 97, 84, 72, 59, 9],
	'AE_UNIGRAMA_7L_OVER_05' :   [96, 172, 156, 139, 123, 107, 91, 74, 9]
}
