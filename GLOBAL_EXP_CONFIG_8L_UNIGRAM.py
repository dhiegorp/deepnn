...
GLOBAL = {
	...
	'log_dir': base_path + '/logs/8layers/unigram/',
	'reports_dir': base_path + '/reports/8layers/unigram/',
	'fullds_reports_dir': base_path + '/reports/8layers/unigram/fullds/',
	'tensorflow_dir': base_path + '/tensorflow/8layers/unigram/',
	'checkpoints_dir':base_path + '/checkpoints/8layers/unigram/',
	'executed_path':base_path + '/executed/8layers/unigram/',
	'data_dir': ds_path + '/',
...
MAP_DIMS = {
	'AE_UNIGRAMA_8L_FULLDS_UNDER_01' :  [96, 28,  26, 24, 22, 20, 19, 17, 15, 9],
	'AE_UNIGRAMA_8L_FULLDS_UNDER_02' :  [96, 76, 69, 63, 56, 49, 43, 36, 29, 9],
	'AE_UNIGRAMA_8L_FULLDS_UNDER_03':   [96, 86, 78, 71, 63, 55, 48, 40, 32, 9],
	'AE_UNIGRAMA_8L_FULLDS_OVER_04':    [96, 134, 122, 109, 97, 84, 72, 59, 47, 9], 
	'AE_UNIGRAMA_8L_FULLDS_OVER_05' :   [96, 172, 156, 139, 123, 107, 91, 74, 58, 9]
}
