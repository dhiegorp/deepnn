...
GLOBAL = {
	...
	'log_dir': base_path + '/logs/8layers/bigram/',
	'reports_dir': base_path + '/reports/8layers/bigram/',
	'fullds_reports_dir': base_path + '/reports/8layers/bigram/fullds/',
	'tensorflow_dir': base_path + '/tensorflow/8layers/bigram/',
	'checkpoints_dir':base_path + '/checkpoints/8layers/bigram/',
	'executed_path':base_path + '/executed/8layers/bigram/',
	'data_dir': ds_path + '/',
...
MAP_DIMS = {
	...
	'AE_BIGRAMA_8L_MINIDS_UNDER_01' : [9216, 5530, 4978, 4426, 3874, 3322, 2770, 2217, 1665],
	'AE_BIGRAMA_8L_MINIDS_OVER_02' : [9216, 10138, 9125, 8112, 7099, 6086, 5074, 4061, 3048],
	'AE_BIGRAMA_8L_MINIDS_OVER_03' : [9216, 13824, 12443, 11061, 9680, 8298, 6917, 5535, 4154],
	'AE_BIGRAMA_8L_MINIDS_OVER_04' : [9216, 14746, 13272, 11798, 10324, 8851, 7378, 5904, 4430],
	'AE_BIGRAMA_8L_MINIDS_OVER_05' : [9216, 15667, 14101, 12535, 10970, 9404, 7838, 6272, 4706],

	'AE_BIGRAMA_8L_FULLDS_UNDER_01' : [9216, 5530, 4978, 4426, 3874, 3322, 2770, 2217, 1665],
	'AE_BIGRAMA_8L_FULLDS_OVER_02' : [9216, 10138, 9125, 8112, 7099, 6086, 5074, 4061, 3048],
	'AE_BIGRAMA_8L_FULLDS_OVER_03' : [9216, 13824, 12443, 11061, 9680, 8298, 6917, 5535, 4154],
	'AE_BIGRAMA_8L_FULLDS_OVER_04' : [9216, 14746, 13272, 11798, 10324, 8851, 7378, 5904, 4430],
	'AE_BIGRAMA_8L_FULLDS_OVER_05' : [9216, 15667, 14101, 12535, 10970, 9404, 7838, 6272, 4706]
