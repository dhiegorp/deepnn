...
GLOBAL = {
	...
	'log_dir': base_path + '/logs/4layers/bigram/',
	'reports_dir': base_path + '/reports/4layers/bigram/',
	'fullds_reports_dir': base_path + '/reports/4layers/bigram/fullds/',
	'tensorflow_dir': base_path + '/tensorflow/4layers/bigram/',
	'checkpoints_dir':base_path + '/checkpoints/4layers/bigram/',
	'executed_path':base_path + '/executed/4layers/bigram/',
	'data_dir': ds_path + '/',
...
MAP_DIMS = {
	...
	'AE_BIGRAMA_4L_MINIDS_OVER_01' : [9216, 9216, 8295, 7375, 6454],
	'AE_BIGRAMA_4L_MINIDS_OVER_02' : [9216, 14746, 13272, 11799, 10325],
	'AE_BIGRAMA_4L_MINIDS_OVER_03' : [9216, 15667, 14101, 12535, 10970],
	'AE_BIGRAMA_4L_MINIDS_OVER_04' : [9216, 16589, 14931, 13273, 11615],
	'AE_BIGRAMA_4L_MINIDS_OVER_05' : [9216, 18432, 16590, 14747, 12905],

	'AE_BIGRAMA_4L_FULLDS_OVER_01' : [9216, 9216, 8295, 7375, 6454],
	'AE_BIGRAMA_4L_FULLDS_OVER_02' : [9216, 14746, 13272, 11799, 10325],
	'AE_BIGRAMA_4L_FULLDS_OVER_03' : [9216, 15667, 14101, 12535, 10970],
	'AE_BIGRAMA_4L_FULLDS_OVER_04' : [9216, 16589, 14931, 13273, 11615],
	'AE_BIGRAMA_4L_FULLDS_OVER_05' : [9216, 18432, 16590, 14747, 12905]
